...
export const INITIAL_MODELS: MachineModel[] = [
  {
    ...
    steps: [
      ...
      { id: 's3', parallelModule: 'A线', module: '结构组装', name: '鞍座与工作台组装', estimatedHours: 8 },
...
// Helper to pre-fill stepStates based on the legacy currentStepIndex for demo purposes
...
export const INITIAL_ORDERS: WorkOrder[] = [
  ...
  },
  {
    ...
    magazineCount: '30T',
    zAxisTravel: '1250mm',
    holidayType: 'SINGLE', // Single off for testing
    stepStates: generateStates('LINMAXB', 1),
    logs: [
        { stepId: 's1', completedAt: generateDate(-1), completedBy: '操作员 B' },
    ],
    ...
    zAxisTravel: '1500mm',
    holidayType: 'DOUBLE',
    stepStates: generateStates('LINMAXB', 0),
    logs: [],
  },
  {
    id: 'GLB3020C32',
