                  ...
                  <div className="p-6 space-y-5 relative z-10">
                      <div className="grid grid-cols-2 gap-4">
                          <div className="col-span-2 md:col-span-1">
                              <label className="block text-xs font-mono text-cyber-blue mb-1 uppercase tracking-wider">異常工序範圍</label>
                              <select 
                          ...
                          <div className="col-span-2 md:col-span-1">
                              <label className="block text-xs font-mono text-cyber-blue mb-1 uppercase tracking-wider">責任單位</label>
                              <select 
                      ...
                      <div>
                          <label className="block text-xs font-mono text-cyber-blue mb-1 uppercase tracking-wider">異常原因詳細說明</label>
                          <textarea 
                      ...
                      <div className="p-4 bg-cyber-bg/50 border border-cyber-muted/20 rounded-sm">
                          <label className="block text-xs font-mono text-cyber-orange mb-3 uppercase tracking-widest border-b border-cyber-orange/20 pb-1">生產控制策略 (影響排程計算)</label>
